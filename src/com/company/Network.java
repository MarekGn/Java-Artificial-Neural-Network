...
public class Network{
    ...
    Network(int... NETWORK_LAYER_SIZES) {
        ...
        for(int i = 0; i<NETWORK_SIZE; i++){
            ...
            this.bias[i] = NetworkRandomFunctions.createRandomArray(NETWORK_LAYER_SIZES[i],-1,1);

            if(i>0){
                weights[i] = NetworkRandomFunctions.createRandomArray(NETWORK_LAYER_SIZES[i],NETWORK_LAYER_SIZES[i-1],-3,3);
            }
        }
    }
